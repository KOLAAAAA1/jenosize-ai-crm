      ...
      <section className="grid grid-cols-2 gap-4 lg:grid-cols-3">
        {stats.map((s) => (
          <div key={s.label} className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <p className="mt-2 break-words text-2xl font-bold tabular-nums text-zinc-900 dark:text-zinc-50 sm:text-3xl">{typeof s.value === "number" ? s.value.toLocaleString() : s.value}</p>
          </div>
        ))}
      </section>
